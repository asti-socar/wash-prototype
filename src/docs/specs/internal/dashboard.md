...
> **리드타임 (Lead Time)**
> 최초 오더 발행 ~ 세차 완료 총 소요시간. 참조 오더 관계(취소→재발행 체인)가 있는 경우 연결된 모든 구간을 합산합니다.
>
> **면책 시간 / 귀책 소요시간**
> 취소 유형의 책임이 "면책"인 취소~재발행 구간은 면책 시간으로 차감됩니다.
> **귀책 소요시간 = 리드타임 − 면책 시간** (수행원 실질 소요시간)
>
> **지연 처리**
> 귀책 소요시간 > 72h인 완료 오더에 대해 발동. 해당 수행원에게 벌점이 부과됩니다.
> 대시보드 경고 기준: 지연 1건(주의) / 3건(위험)
>
> 상세 정의는 오더 관리 스펙(orders.md) 섹션 2.5~2.6을 참조하세요.
