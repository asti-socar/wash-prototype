...
| 취소 유형 | 설명 |
| :--- | :--- |
| 변경 취소 | 오더 내용 변경 시 기존 오더 취소 후 재발행 |
| 미예약 취소 | 발행 후 24시간 내 파트너 예약 미완료 |
| 노쇼 취소 | 예약 시간에 차량 미도착 또는 수행 불가 |
| 수행원 취소(차량 없음) | 배정된 차량이 존에 없음 |
| 수행원 취소(예약 불가) | 예약 가능한 시간대 없음 |
| 수행원 취소(주차장 문제) | 주차장 접근 불가 |
| 수행원 취소(기타) | 기타 사유 |
| 수행원 취소(개인 사유) | 수행원 개인 사정 |
| 우천 취소 | 우천으로 세차 불가 |
